...
pub const VERSION: RuntimeVersion = RuntimeVersion {
    spec_name: create_runtime_str!("fennel-node-runtime"),
    impl_name: create_runtime_str!("fennel-node-runtime"),
    authoring_version: 1,
...
// We need a custom validator conversion struct
...
impl pallet_validator_manager::Config for Runtime {
    ...
    type ValidatorOf = ValidatorOf<Self>;
}
