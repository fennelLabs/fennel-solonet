...
mod benchmarks {
    ...
    fn set_signal_parameter() -> Result<(), BenchmarkError> {
        ...
        assert!(SignalParameterList::<T>::contains_key(
            caller.clone(),
            target.clone()
        ));
        assert_eq!(
            SignalParameterList::<T>::get(caller.clone(), target.clone()),
            0
        );
    ...
    fn send_rating_signal() -> Result<(), BenchmarkError> {
        ...
        assert!(RatingSignalList::<T>::contains_key(
            caller.clone(),
            target.clone()
        ));
        assert_eq!(
            RatingSignalList::<T>::get(caller.clone(), target.clone()),
            0
        );
